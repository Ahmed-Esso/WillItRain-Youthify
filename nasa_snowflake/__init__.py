...
defs = Definitions(
    jobs=[nasa_daily_weather_pipeline,nasa_daily_dewpoint_2022_pipeline,nasa_daily_wetbulb_2022_pipeline,nasa_daily_wind_speed_2022_pipeline,nasa_daily_surface_pressure_2022_pipeline]
)
